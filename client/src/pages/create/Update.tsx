...
function Update() {
    ...
    }, [plane?.model, plane?.image, plane?.capacity, plane?.captain, plane?.country, plane?.type, plane?.year])
    ...
    const handleEdit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const editPlane = await axios.put(
                `${baseURL}/api/Airport/${params.id}`,
                updatePlane, {
                headers: {
            ...
            if (editPlane) {
                toast.success("Plane Updated!")
                console.log(editPlane.data);
            }
        } catch (error) {
            const err = error as AxiosError
            if (!err.response) {
