    ...
    return (
        <div className='bg-white shadow-md'>
            <nav className='flex justify-between items-center w-[92%] mx-auto'>
                ...
                <div className={
                    open
                        ? 'duration-500 md:static absolute z-20 bg-white md:min-h-fit min-h-[30vh] left-0 top-[-100%] md:w-auto w-full flex items-center px-5 justify-center'
                        : 'duration-500 md:static absolute z-20 bg-white md:min-h-fit min-h-[30vh] left-0 top-[9%] md:w-auto w-full flex items-center px-5 justify-center'
                }>
